...
@include('includes/sidebar' , ['state' => 'edit-user'] )
	...
	<h1>Edit {{$user->name}} Profile</h1>
	 ...
	 <div class="row">
        <div class="col-md-8 " style="margin-left: 3%; margin-top:3%;">
           ...
           <div class="panel-heading"><h3 style="color: white; ">Edit User</h3></div>
            <div class="panel-body">
            
            <form action="{{ route('save.edit', ['id' => $user->id]) }} " method="post">
                ...
                <div class="form-group {{ $errors->has('job_type')?'has-error':'' }}" id="www">
				   ...
				   <select name="job_type" class="form-control" path="www">
				   		<option value="{{$user->job_type}}" selected id="ad"></option>	
                ...
                <div  class="form-group {{ $errors->has('phone')?'has-error':'' }}" id="p">
                    ...
                    <input class="form-control" type="text" id="manager_experiances" name="manager_experiances" value="@if($user->job_type == 2){{$manager->xp_id}} @endif">
                 ...
                 <div class="form-group {{ $errors->has('phone')?'has-error':'' }}" id="d">
                    ...
                    <input class="form-control" type="text" id="prog_lang" name="prog_lang" value="@if($user->job_type == 3){{$developer->prog_langs}} @endif">
                 ...
                 @endif                 
                  ...
                  <div class="form-group {{ $errors->has('phone')?'has-error':'' }}" id="t">
                    <label for="phone">Experiances</label>
                    <input class="form-control" type="text" id="tester_experiances" name="tester_experiances"  value="@if($user->job_type == 4){{$tester->years_xp}} @endif">
